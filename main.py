...
background = pygame.image.load("./resources/images/background3.png").convert_alpha()
...
def draw_level_cleared():
    ...
    if level.number_of_birds >=0 and len(pigs)==0 :
        ...
        if score >= level.two_star and score <= level.three_star:
            screen.blit(star1, (310, 190))
            screen.blit(star2, (510, 170))

        if score >= level.three_star:
            screen.blit(star1, (310, 190))
            screen.blit(star2, (510, 170))
            screen.blit(star3, (710, 200))
...
while running :
    ...
    for line in static_lines:
        ...
        pygame.draw.lines(screen,(155,155,155),False,[p1,p2])
    ...
    for pig in pigs:
        ...
        img=pygame.transform.rotate(pig_image,angle_degree)
